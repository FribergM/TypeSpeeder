...
public class NewsLetterTest {
    ...
    public void testNewsLetterClassExists() {
        try {
            Class.forName("se.ju23.typespeeder.services.NewsLetter");
    ...
    public void testNewsLetterContentLength() {
        try {
            Class<?> newsLetterClass = Class.forName("se.ju23.typespeeder.services.NewsLetter");
    ...
    public void testNewsLetterPublishDateTime() {
        try {
            Class<?> someClass = Class.forName("se.ju23.typespeeder.services.NewsLetter");
            ...
            assertEquals("2024-02-23 09:36:20", formattedDateTime, "'publishDateTime' field should have format 'yyyy-MM-dd HH:mm:ss'.");
